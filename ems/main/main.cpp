...
static void initDatabaseRecord()
{
    ...
    UserManager::insertIntoDefaultRecord();
}
...
int main()
{
    ...
    strategyDataDealer->set(zmq::sockopt::routing_id, "Strategy0Data");
    ...
    strategyCmdDealer->set(zmq::sockopt::routing_id, "Strategy0Cmd");
    ...
    strategySetDealer->set(zmq::sockopt::routing_id, "Strategy0Set");
    ...
    auto processorDataDealer = make_shared<zmq::socket_t>(zeromq::contextSingleton(), zmq::socket_type::dealer);
    processorDataDealer->set(zmq::sockopt::routing_id, "Processor");
    processorDataDealer->connect("tcp://127.0.0.1:9005");

    auto processor = make_shared<Processor>(processorDataDealer);
    processor->start();
    //////////////////////////////////////////////////////////////
